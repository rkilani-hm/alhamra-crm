-- ============================================================
-- Web Intake Form: new categories + routing config
-- ============================================================
...
-- Maps inquiry_type → default department name
-- Edge function uses this to auto-assign new web cases
CREATE TABLE IF NOT EXISTS public.intake_routing (
  id            uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  inquiry_type  text NOT NULL UNIQUE,
  department_name text NOT NULL,  -- matched by name since IDs are dynamic
...
-- Web form submissions table (raw log before case creation)
...
CREATE POLICY "submissions_insert" ON public.web_submissions FOR INSERT WITH CHECK (true); -- public
