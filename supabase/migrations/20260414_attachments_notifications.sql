...
CREATE TABLE IF NOT EXISTS public.notifications (
  ...
  type        text NOT NULL, -- case_assigned | case_overdue | wa_message | case_updated
  title       text NOT NULL,
  body        text,
  link        text,          -- deep link e.g. /follow-up or /contacts/:id
...
CREATE POLICY "notifs_insert" ON public.notifications FOR INSERT TO authenticated
  WITH CHECK (true); -- edge functions + triggers can insert for any user
...
BEGIN
  -- Notify all members of the receiving department
