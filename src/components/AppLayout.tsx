...
const SECTIONS: { section: string; roles: NavRole[]; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items:   [
      ...
      { to: '/admin/sap',        label: 'SAP Sync',     icon: Database,        roles: ['manager']           },
      { to: '/admin/sla',        label: 'SLA Config',   icon: Timer,           roles: ['manager']           },
    ...
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      >
        ...
        <button
          ...
          style={{
            position: 'absolute', right: -12, top: 64, zIndex: 30,
